...
export default {
  ...
  data () {
    return {
      ...
      data: [],
      SaleEchartsDays: [],
      OrderEchartsValue: [0, 0, 0, 0, 0, 0, 0],
      OrderEchartsIsShow: false
    }
  },
  ...
  methods: {
    ...
    async getDayMpNumByDate () {
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          ...
          this.OrderEchartsValue[0] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[1] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[2] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[3] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[4] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[5] = res.data
        })
      service.post('getDayMpNumByDate', {
        ...
        .then(res => {
          console.log(res.data)
          this.OrderEchartsValue[6] = res.data
          this.setOrderEcharts(this.eachId, [
            { name: this.SaleEchartsDays[6], value: this.OrderEchartsValue[6] },
            { name: this.SaleEchartsDays[5], value: this.OrderEchartsValue[5] },
            { name: this.SaleEchartsDays[4], value: this.OrderEchartsValue[4] },
            { name: this.SaleEchartsDays[3], value: this.OrderEchartsValue[3] },
            { name: this.SaleEchartsDays[2], value: this.OrderEchartsValue[2] },
            { name: this.SaleEchartsDays[1], value: this.OrderEchartsValue[1] },
            { name: this.SaleEchartsDays[0], value: this.OrderEchartsValue[0] }
          ])
        })
    }
  },
